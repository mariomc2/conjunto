...
class ResidentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resident" do
    assert_difference('Resident.count') do
      post residents_url, params: { resident: { apartment_id: @resident.apartment_id, email: @resident.email, name: @resident.name, telephone: @resident.telephone } }
    end
  ...
  test "should update resident" do
    patch resident_url(@resident), params: { resident: { apartment_id: @resident.apartment_id, email: @resident.email, name: @resident.name, telephone: @resident.telephone } }
